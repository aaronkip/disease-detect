...
import 'package:disease_detect/main/model/AppMoel.dart';
import 'package:disease_detect/main/model/ListModels.dart';
import 'package:disease_detect/main/screens/ProkitScreenListing.dart';
import 'package:disease_detect/main/utils/flix_constants.dart';
...
Widget commonCacheImageWidget(String url, double height, double width,
    {BoxFit fit}) {
...
Widget settingItem(context, String text, Function onTap,
    {Widget detail, Widget leading}) {
  return InkWell(
    onTap: onTap,
    child: Container(
